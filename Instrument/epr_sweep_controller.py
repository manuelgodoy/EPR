...
def sweep(start_voltage, sample):
    ...
    magnet_value = controller.set_magnet_value(VOLTAGE_START)
    c.write_data_v2(0x10,magnet_value)
    ...
    for i in xrange(NUMBER_OF_POINTS):
        ...
        magnet_value = controller.set_magnet_value(i*RESOLUTION+start_voltage)
        c.write_data_v2(0x10,magnet_value)
    ...
    magnet_value = controller.set_magnet_value(0)
    c.write_data_v2(0x10,magnet_value)
