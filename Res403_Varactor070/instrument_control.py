...
# sensitivity_lowfreqlockin = ['2e-9','5e-9','10e-9','20e-9','50e-9','100e-9','200e-9','500e-9','1e-6',
#                 '2e-6','5e-6','10e-6','20e-6','50e-6','100e-6','200e-6','500e-6','1e-3',
#                 '2e-3','5e-3','10e-3','20e-3','50e-3','100e-3','200e-3','500e-3','1']
# time_constants_lowfreqlockin = ['10us','30us','100us','300us','1ms','3ms','10ms','30ms','100ms','300ms',
...
class Instrument(object):
    ...
    def write(self, command, *value):
        if value:
            return self.resource.write(command+ ' ' +value[0])
